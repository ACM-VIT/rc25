...
const ClickableBox = ({ title }: { title: string }) => (
    <div className="relative flex flex-col items-center text-white transform hover:scale-105 transition-transform duration-200 mx-6 my-4">
      ...
      <div className="flex flex-col items-center space-y-1 px-4 py-2">
        <span className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold" style={{
...
export default function Allies() {
    return (
      <div className="relative w-screen h-screen overflow-hidden">
        ...
        {/* Vertical Right Text */}
        <div className="absolute right-2 lg:right-8 top-0 h-full flex items-stretch z-10 py-8">
          <div
            className="text-white  text-lg sm:text-xl md:text-[2.3rem] lg:text-[2.4rem] font-aurebesh tracking-[0.2em] uppercase flex-1 flex items-center justify-center whitespace-nowrap"
            style={{
                writingMode: "vertical-rl",
                transform: "rotate(180deg)",
                WebkitTextStroke: "2px white", 
                color: "transparent", 
                textShadow: "0 0 10px rgba(128, 0, 128, 0.8), 0 0 20px rgba(128, 0, 128, 0.6)", // Purple glow
              }}
          >
            CODE, invert, conquer
          </div>
