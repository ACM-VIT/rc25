...
import v5 from "../../../../public/Vector(5).png"
import v7 from "../../../../public/Vector(7).png"
import v8 from "../../../../public/Vector(8).png"
...
const RegisterNowMobile: React.FC = () => {
    ...
    <>
     <div className="absolute inset-0 z-20">
            <Image
              ...
              src={dark}
              fill
              className="object-center opacity-[2]  transform fix"
              priority
  ...
  <div className="relative w-20 h-20 ">
    ...
    <div className="absolute inset-0 z-10">
      ...
      <div className="how-it-works-heading text-white content-center text-center h-1/4 w-full text-3xl lg:text-[80px] xl:text-[115px]">
      <p>Reach us at</p>
