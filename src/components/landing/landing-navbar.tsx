      ...
      <div className="flex justify-between items-center w-full px-4 sm:px-6 md:px-8 lg:px-14 xl:px-20">
        ...
        <ul className="flex flex-row gap-2 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-10 list-none items-center">
          ...
          <li className="relative z-10 font-outfit">
            <button
              onClick={SignIn}
              className="block px-4 py-2 sm:px-6 sm:py-3 lg:px-8 lg:py-4 xl:px-10 xl:py-5 xl:text-xl 2xl:text-2xl 3x:text-3xl 4xl:text-4xl bg-transparent hover:bg-[#9B51E0] hover:text-white rounded-full transition-all duration-300 ease-in-out text-sm sm:text-base lg:text-lg "
            >
              <b>Sign In</b>
            </button>
          </li>
