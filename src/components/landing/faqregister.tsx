      ...
      <div className="grow pt-10">
        <div className="flex flex-col">
          ...
          <div className="flex justify-start pl-10 lg:pl-14 md:pl-10 sm:pl-8 xs:pl-8 phone:pl-6">
            <div className={`bg-linear-to-b from-[#F0F1FA] to-[#ACADB5] bg-clip-text text-transparent text-center phone:text-[4rem] xs:text-[6rem] sm:text-[8rem] md:text-[9rem] lg:text-[10rem]`}>
              FAQ
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-28 gap-y-12 lg:gap-x-28 lg:gap-y-16 lg:px-28 md:gap-x-16 md:gap-y-8 md:px-16 p-10 sm:px-16 sm:gap-y-8 xs:px-12 xs:gap-8 phone:px-8 phone:gap-4 phone:p-4 z-5">
            {faqItems.map((item, _) => (
              ...
              >
                <div className="absolute inset-0 bg-[#222222] bg-opacity-80 rounded-lg border border-[rgba(155,81,224,0.5)]" />
          ...
          <div className="flex items-center justify-center lg:pt-48 lg:pb-36 md:pt-36 md:pb-32 sm:pt-32 sm:pb-28 xs:pt-28 xs:pb-24 phone:pt-28 phone:pb-28">
              <div
                  className={`bg-linear-to-b from-[rgba(254,254,254,1)] to-[rgba(254,254,254,0.2)] bg-clip-text text-transparent text-center phone:text-[3rem] xs:text-[4rem] sm:text-[5rem] md:text-[6rem] lg:text-[10rem] leading-none max-w-full overflow-hidden`}
              >
                  REGISTER<br />NOW
              </div>
          </div>
