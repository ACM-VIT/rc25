...
export default function QuestionDisplay({
    ...
    return (
        <DashboardBox className="rounded-[10px] flex flex-col h-full w-full border border-[#A7282D]">
            {/* Main Content Area (Expands) */}
            <ScrollArea className="rounded-[10px] w-full min-h-0 flex-1">
                <div className="flex items-center justify-between mx-4 mb-4 flex-wrap">
