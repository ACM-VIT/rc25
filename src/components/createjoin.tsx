      ...
      <div className="w-[90vw] md:w-[50vw] lg:w-[40vw] p-6 rounded-lg bg-[#1c1c1c] border-2 border-purple-700 flex flex-col md:flex-row gap-4">
        <div className="flex-shrink-0 flex justify-center items-center">
          <Image
            ...
            alt={mode === "CREATE" ? "Create Team" : "Join Team"}
        ...
        <div className="flex-grow">
          ...
          <div className="mb-4">
            <label htmlFor="team-input" className="block font-semibold mb-2">
              {mode === "CREATE"
          ...
          {randomCode && (
            <div className="mt-4 p-4 bg-purple-700 bg-opacity-20 rounded-lg border-2 border-purple-700">
