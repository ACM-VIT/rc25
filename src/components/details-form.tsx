...
function SubmitButton() {
  ...
  return (
    <button
      ...
      disabled={pending}
      className={`${formula1Bold.className} mx-auto mt-8 flex h-[56px] w-full max-w-[357px] items-center justify-center rounded-[10px] border-[3px] border-[#a7282d] bg-[linear-gradient(180.008deg,rgba(0,0,0,0.93)_0%,rgba(42,42,42,0.93)_176.23%)] text-center text-[18px] uppercase leading-[1.5] text-white shadow-[0px_0px_26.989px_0px_#9f242d,0px_0px_15.422px_0px_#9f242d,0px_0px_8.996px_0px_#9f242d,0px_0px_4.498px_0px_#9f242d,0px_0px_1.285px_0px_#9f242d,0px_0px_0.643px_0px_#9f242d] transition-[filter,opacity,transform] duration-200 hover:brightness-110 active:brightness-125 disabled:opacity-60 md:h-[76px] md:border-[6px] md:text-[28px]`}
    >
...
export default function OnboardingForm() {
  ...
  return (
    <main
      className="relative h-screen w-full overflow-hidden bg-[#0c0c0c] max-sm:overflow-y-auto"
    >
      <img
      ...
      <div className="relative z-10 flex min-h-screen w-full flex-col items-center">
        ...
        <p
          className={`${formula1Bold.className} mt-6 w-full max-w-[1500px] px-6 text-center text-[12px] leading-[1.5] text-white sm:text-[14px] md:text-[20px]`}
        >
        ...
        <form
          action={onboard}
          className="mt-10 w-full max-w-[608px] px-6"
          onSubmit={(e) => {
          ...
          <div className="flex flex-col gap-8 md:gap-10">
            ...
            <div>
              <label
                ...
                className={`${formula1Bold.className} mb-4 block text-center text-[14px] leading-[1.5] text-white sm:text-[16px] md:text-[20px]`}
              >
                Contact Number
              </label>
              <div className="w-full">
                <div className="relative w-full bg-[#080a0d] md:h-[117.566px]">
                  <div className="flex items-center gap-4 px-6 pb-6 pt-10 md:pb-7 md:pt-11">
                  <img
                  ...
                  <input
                    ...
                    className={`${formula1Bold.className} w-full bg-transparent text-[18px] leading-[normal] text-white outline-none placeholder:text-white/35 sm:text-[22px] md:text-[27px]`}
                  />
                  </div>
                  <div className="absolute left-0 right-0 bottom-[14px] h-[2px] bg-[#a7282d]" />
                </div>
              <div className="relative h-[12.435px] w-full overflow-hidden bg-[#222221]">
                <div
                  aria-hidden="true"
