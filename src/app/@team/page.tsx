    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center bg-black text-white font-sans">
            <div className="w-[90vw] md:w-[50vw] lg:w-[40vw] p-6 rounded-lg bg-[#1c1c1c]">
                {randomCode ? (
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold mb-4">Your Team Code:</h2>
                        <div className="flex items-center justify-between p-4 bg-gray-800 rounded">
                            <span className="text-xl font-mono">{randomCode}</span>
                            <button
                                onClick={copyToClipboard}
                                className="ml-4 px-4 py-2 bg-purple-700 hover:bg-purple-800 rounded"
                            >
                                Copy
                            </button>
                        </div>
