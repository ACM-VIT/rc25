...
//       <div className="absolute left-6 -top-[25px] translate-y-3/4 -translate-x-1/2 transform z-10">
...
//       <div className="absolute right-8  translate-x-1/2 transform bottom-2 -translate-y-3/4 z-10">
//         <div className="vertical-text transform how-it-works-heading -rotate-90 text-glow font-extrabold text-[35px] sm:text-[20px] md:text-[30px] lg:text-[30px] xl:text-[45px] tracking-widest">
//           Catch
//         </div>
//       </div>
...
//       <div className="absolute how-it-works-heading z-10 text-white text-center w-full lg:text-[80px] xl:text-[115px]">
//         Bounty Purse
//       </div>
