...
const TeamSubmissions= ()=>{
    const [name, setName] = useState("Vansh Dhir");
    ...
    return (
        <>
            <Navbar name={name}/>
            <div
                className="flex flex-col items-center text-white justify-center bg-[radial-gradient(110.8%_70.71%_at_50%_50%,_#0B0014_55.41%,_#18181B_100%)] min-h-screen">
                ...
                <div className="text-white bg-[#39234E] w-[90vw] h-[80vh] rounded-lg">
