  ...
  return (
    <div className="min-h-screen bg-black text-white relative w-full pt-10 pb-10 z-[10]">
      <div className="flex flex-col h-full">
        ...
        <div className="flex h-full items-center justify-center lg:pt-48 lg:pb-36 md:pt-36 md:pb-32 sm:pt-32 sm:pb-28 xs:pt-28 xs:pb-24 phone:pt-28 phone:pb-28">
            <div
      ...
      <div className="absolute right-0 bottom-0 z-[1] animate-spin-slow-reverse">
        <Image
          className="hidden md:block h-auto"
          src={whiteround}
          alt="White Circle"
