  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: "url('./dashbg.png')", backgroundSize: "cover" }}
      >
        ...
        <div className="flex flex-row gap-5 w-[95%] h-[85%]">
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="w-full">
              <DashboardBox className="p-6 text-center py-4">
                <CountdownTimer getTimeUntil={roundInfo.end.toISOString()} />
              </DashboardBox>
            </div>
          </div>
          <div className="flex w-full flex-col lg:flex-row lg:space-x-4 space-y-4 lg:space-y-0">
            <DashboardBox className="w-full lg:w-[70%] p-7 pt-0 overflow-hidden">
              ...
              <div className="flex flex-row border-b-2 pb-4 w-full">
                <h1 className="w-1/6 text-xs md:text-sm font-bold text-center">Sr. No</h1>
                        ...
                        <p
                          ...
                          style={{
                            color: (() => {
                              ...
                              const [passed, total] = question.status
                                .split("/")
                                .map(Number);
            ...
            <DashboardBox className="w-full max-h-[40%] overflow-y-auto lg:w-[30%] lg:max-h-full">
              <p className="text-2xl font-semibold border-b-2 border-white p-2 py-4 mb-4">
                Leaderboard
              </p>
              <ul className="space-y-3 pt-4 px-1">
